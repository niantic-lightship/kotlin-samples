...
android {
    namespace = "com.nianticspatial.ardk.externalsamples"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.nianticspatial.ardk.externalsamples"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "3.17.0"
...
dependencies {
    ...
    implementation(files("libs/generated/ARDK-release.aar"))
