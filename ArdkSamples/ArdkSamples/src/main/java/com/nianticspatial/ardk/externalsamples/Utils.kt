...
class Utils {
    companion object {
        ...
        fun hasCameraPermissions(context: Context): Boolean {
            return hasPermissions(context, android.Manifest.permission.CAMERA)
        }

        fun hasLocationPermissions(context: Context): Boolean {
            return hasPermissions(context, android.Manifest.permission.ACCESS_FINE_LOCATION)
        }
                    ...
                    try {
                        ...
                        when (ArCoreApk.getInstance().requestInstall(activity, true)) {
                            InstallStatus.INSTALL_REQUESTED -> {
                                Log.i("ARDK", "ARCore installation requested.")
                                false
                            }
                        ...
                        Log.e("ARDK", "ARCore not installed", e)
                        false
                    }
                }
