...
import com.nianticlabs.ardk.mesh.MeshDownloaderSession
...
class MeshDownloadManager(
  ...
  private val meshDownloaderSession: MeshDownloaderSession = ardkSession.meshDownload.acquire()
  private var downloadJob: Job? = null

  var _meshDownloadCallback : ((Array<MeshDownloaderData>) -> Unit)? = null

  fun startDownload(locationName: String, payload: String, meshDownloadCallback: ((Array<MeshDownloaderData>) -> Unit)? = null) {
