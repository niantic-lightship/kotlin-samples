...
import com.nianticlabs.ardk.Image
...
class SemanticsOverlayContent(
    private val semanticsManager: SemanticsManager,
    private val ardkSessionManager: ARDKSessionManager,
) : OverlayContent() {
    ...
    private var opacity: Float = semanticsManager.overlayOpacity.value
    ...
    override fun onFrame(engine: Engine, materialInstance: MaterialInstance): Boolean {
        val result = semanticsManager.latestResult.value ?: return false
        val frame = ardkSessionManager.currentFrame ?: return false
    ...
    private fun updateUvTransform(
        ...
        try {
            ...
            val display = ImageMath.displayTransform(
                orientation = ardkSessionManager.arManager.lastImageOrientation,
